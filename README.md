...
Yes, overall I was mostly prepared for the project. From the lectures to the labs and the live demo done in class all helped to prepare me. But for some additional features that I wanted to add I used the help of claude to implement those features.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

I would have added more CSS features, such as the hover feature and adding more movement and features to make the website fell more polished and intentional.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I was able to cover and show off the features of my projects and discuss the intentionality of my website and the features I implemented. Something I noticed my peers did was they added a nav bar at the bottom of the screen as well, so I would have like to implement that and also add more hover features.
...
-Paulo gave me great feedback on how to make my website better and meet the requiremnets for my submission, such as ensuring i had captions on each photo.
-Greg helped me when I would hit some speed bumbs and was tehre to help me deduce what my issue was and how to fix it.